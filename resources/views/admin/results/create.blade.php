        ...
        <div class="card p-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="fas fa-plus-circle text-primary me-2"></i> Add New Result</h4>
                ...
                <form action="{{ route('admin.results.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="course" class="form-control" value="{{ old('course', 'B.Tech') }}" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="subject1" class="form-control" value="{{ old('subject1', 0) }}" min="0" max="100" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Subject 2</label>
                            <input type="number" name="subject2" class="form-control" value="{{ old('subject2', 0) }}" min="0" max="100" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Subject 3</label>
                            <input type="number" name="subject3" class="form-control" value="{{ old('subject3', 0) }}" min="0" max="100" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Subject 4</label>
                            <input type="number" name="subject4" class="form-control" value="{{ old('subject4', 0) }}" min="0" max="100" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Subject 5</label>
                            <input type="number" name="subject5" class="form-control" value="{{ old('subject5', 0) }}" min="0" max="100" required>
                        </div>
